...
The KB lives at `agents/nick/knowledge_base/` with four typed subdirectories, each grouped by ticker:

| Folder | Contents | Path pattern | File naming |
|---|---|---|---|
| `agents/nick/knowledge_base/transcripts/<TICKER>/` | Earnings call transcripts | `agents/nick/knowledge_base/transcripts/GOOG/GOOG-2025-01-30-transcript.md` | `<TICKER>-<YYYY-MM-DD>-transcript.md` |
| `agents/nick/knowledge_base/filings/<TICKER>/` | 10-K, 10-Q, annual reports | `agents/nick/knowledge_base/filings/GOOG/GOOG-2025-12-31-10K.md` | `<TICKER>-<YYYY-MM-DD>-<10K\|10Q>.md` |
| `agents/nick/knowledge_base/articles/<TICKER>/` | Analyst reports, news, research notes | `agents/nick/knowledge_base/articles/GOOG/GOOG-2025-05-01-earnings-note.md` | `<TICKER>-<YYYY-MM-DD>-<tag>.md` |
| `agents/nick/knowledge_base/theses/` | Nick's own thesis files (one per ticker) | `agents/nick/knowledge_base/theses/GOOG.md` | `<TICKER>.md` |

General (non-ticker) articles go in `agents/nick/knowledge_base/articles/general/` with naming `general-<YYYY-MM-DD>-<tag>.md`.

## How to Scan

### Full KB scan (used by Nick_Init)
```
Glob: agents/nick/knowledge_base/**/*.md
...
- For **Nick_Weekly**: scan only files modified after the `last_reviewed` date in `agents/nick/portfolio.md`
...
Never fill gaps with training-data knowledge of real companies. All analysis must come from files in `agents/nick/knowledge_base/`.
